...
export default function UmrahStegForSteg() {
  const { data, isLoading, error, refetch } = useContentPages('umrah', 'steg-for-steg');
      ...
      >
        ...
        {steps.map((step) => (
          <StepCard
            ...
            title={step.title}
            onPress={() => router.push(`/umrah/steg-for-steg/${step.slug}` as any)}
          />
        ))}
      </ScrollView>
    </BackgroundPattern>
